...
const BottomBar = ({isDark}:any) => {
  return (
    <div className="flex justify-center m-auto" >
        <div className={`${isDark}bg-neutral-800 text-white flex items-center fixed w-[90%] lg:hidden bottom-5 py-4 px-6 rounded-full backdrop-filter backdrop-blur-3xl bg-opacity-60 `}>
