        ...
        <section id='projects' className={` lg:py-[7rem] py-[5rem] 2xl:px-[20rem] xl:px-[10rem] lg:px-[8rem] px-5 ${isDark === true ? dark : light2}`}>
            ...
            <div className='grid lg:grid-cols-2 gap-6  grid-cols-1 items-center mt-10'>
                {WorksData.map((data, index)=>(
                    <div data-aos="fade-up" data-aos-duration="600" key={index} className={`${isDark === true ? 'bg-neutral-800 border border-neutral-700 text-white' : 'bg-neutral-100  text-neutral-800'} p-3 rounded-2xl`}>
